...
public class CustomViewBehind extends ViewGroup {
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		return mViewAbove.onInterceptTouchEvent(e);//https://github.com/jfeinstein10/SlidingMenu/issues/446
	}

	@Override
	public boolean onTouchEvent(MotionEvent e) {
//		return !mChildrenEnabled;
		return mViewAbove.onTouchEvent(e);//https://github.com/jfeinstein10/SlidingMenu/issues/446
	}
